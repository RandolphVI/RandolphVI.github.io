...
[^2]: 个人观察：RCNN 比 CNN 性能高 1−2 个百分点的原因在于双向 RNN 能建模上下文两个方向的语义信息，补齐了 CNN 对上下文不敏感的短板。
