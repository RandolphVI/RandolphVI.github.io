...
EasyEnsemble 的想法是多次随机欠采样，尽可能全面地涵盖所有信息，算法特点是利用 **boosting** 减小偏差（Adaboost）、<strong>bagging</strong> 减小方差（Ensemble Classifier）。实际应用的时候也可以尝试选用不同的分类器来提高分类的效果。算法的流程如下：
