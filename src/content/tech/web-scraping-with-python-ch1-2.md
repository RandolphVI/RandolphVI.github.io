...
description: "- BeautifulSoup package"
draft: false
---
...
|  |  |
| --- | --- |
| ``` 1 2 3 ``` | ``` bsObj.tr bsObj.table.tr bsObj.find('table', {'id': 'giftList'}).tr ``` |
