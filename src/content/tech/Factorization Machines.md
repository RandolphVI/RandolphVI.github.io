...
Factorization Machines（FM），可译为“隐因子分解机”，由 Steffen Rendle 于 2010 年提出，并发布开源工具 **libFM**[^1] 。他凭借 FM 单个模型，在 KDD Cup 2012[^2]上取得 Track1 的第 2 名和 Track2 的第 3 名。
...
- **马尔可夫链蒙特卡洛法 （Markov Chain Monte Carlo, MCMC）**[^3]
